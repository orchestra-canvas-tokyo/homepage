...
import term1Image from './documents/第1期 決算報告書.png?enhanced';
import term2Pdf from './documents/第2期 決算報告書.pdf';
import term2Image from './documents/第2期 決算報告書.png?enhanced';
import term3Pdf from './documents/第3期 決算報告書.pdf';
import term3Image from './documents/第3期 決算報告書.png?enhanced';
